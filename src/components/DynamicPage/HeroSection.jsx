    ...
    <>
      <section>
        <div className="flex relative mt-5 h-[500px] w-full">
          {/* Background Image */}
          <img src={`http://localhost:8000/uploads/${location.heroSectionImage.replace('\\', '/')}`} className="md:w-full min-w-full h-full object-cover" alt="Background" />
          {/* Gradient Overlay */}
          ...
          <div className="absolute ml-16 mt-32 space-y-5">
            <h1 className="md:text-6xl text-4xl text-[#F5F5DC] font-bold">{location.momentIssue}</h1>
              <div>
